...
<{{ $element }}
    {{ $attributes->class([
        'relative inline-flex items-center justify-center rounded-2xl px-10 py-5 text-center text-xl font-bold uppercase shadow-[0_0_5px_rgba(0,0,0,0.25)] transition-transform hover:scale-105 active:brightness-90 sm:px-14 sm:text-2xl',
